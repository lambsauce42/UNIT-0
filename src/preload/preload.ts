...
const api: UnitApi = {
  ...
  chat: {
    ...
    updateDocumentIndex: (payload: ChatUpdateDocumentIndexPayload) => ipcRenderer.invoke("chat:updateDocumentIndex", payload),
    deleteDocumentIndex: (payload: ChatDeleteDocumentIndexPayload) => ipcRenderer.invoke("chat:deleteDocumentIndex", payload),
